...
<head>
    ...
    <link rel="stylesheet" href="css/estilologinA.css">
</head>
<body>
<form method="post" action="loginAdmin.php" name="signin-form">
    ...
    <button type="submit" name="enviar" value="loginA">Iniciar sesion</button>
    <?php
